...
export default function Navbar(props) {
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="d-flex">
        ...
        <div className="bg-white  rounded mx-2 " onClick={()=>{props.toggleMode('light')}} style={{height:'30px', width:'30px', cursor:'pointer' ,border:'2px solid black'}}></div>
        </div>
  ...
  <label className="form-check-label" HTMLfor="flexSwitchCheckDefault">{props.btnTextt}</label>
</div> */}
